...
import { Home, Clock, User, Settings, LogOut } from 'lucide-react'
  ...
  return (
    <nav className="bg-emerald-900/50 backdrop-blur-sm border-b border-emerald-800">
      ...
      <div className="md:hidden">
        <div className="flex items-center justify-center px-4 py-3 pt-safe">
          <Link href="/dashboard?view=juz" className="text-xl font-bold text-[#F5F5DC]">
            Al-Murajaah
          </Link>
        </div>
        {/* Fixed bottom navigation bar for mobile */}
        <div className="fixed bottom-0 left-0 right-0 bg-emerald-900/50 backdrop-blur-sm border-t border-emerald-800 pb-safe">
